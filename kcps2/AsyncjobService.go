...
// Retrieves the current status of exasynchronous job.
func (s *AsyncjobService) QueryExAsyncJobResult(p *QueryAsyncJobResultParams) (*QueryAsyncJobResultResponse, error) {
	var resp json.RawMessage
	var err error
