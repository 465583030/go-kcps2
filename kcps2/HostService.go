...
// It was added for listDistributionGroups
// Lists distribution groups.
func (s *HostService) ListDistributionGroups() (*ListDistributionGroupsResponse, error) {
	resp, err := s.cs.newRequest("listDistributionGroups", url.Values{})
	if err != nil {
		return nil, err
	}
...
type ListDistributionGroupsResponse struct {
	Count             int `json:"count"`
	Distributiongroup []struct {
		Name string `json:"name"`
	} `json:"distributiongroup"`
}
